...
bool TPDU::numbered() const { return (_data[0] & 0x40) > 0; }
...
bool TPDU::control() const { return (_data[0] & 0x80) > 0; }
...
uint8_t TPDU::sequenceNumber() const { return ((_data[0] >> 2) & 0xF); }
...
APDU &TPDU::apdu() { return _frame.apdu(); }

CemiFrame &TPDU::frame() { return _frame; }
