...
// temporary undef until framework-arduino-samd > 1.8.9 is released. See
// https://github.com/arduino/ArduinoCore-samd/pull/399 for a PR should will probably address this
#undef max
#undef min
