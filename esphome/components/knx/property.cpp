...
PropertyID Property::Id() const { return _id; }

bool Property::WriteEnable() const { return _writeEnable; }

PropertyDataType Property::Type() const { return _type; }

uint16_t Property::MaxElements() const { return _maxElements; }

uint8_t Property::Access() const { return _access; }
...
Property::Property(PropertyID id, bool writeEnable, PropertyDataType type, uint16_t maxElements, uint8_t access)
...
uint8_t Property::read(uint8_t *value) const { return read(1, 1, value); }
...
uint8_t Property::write(const uint8_t *value) { return write(1, 1, value); }
