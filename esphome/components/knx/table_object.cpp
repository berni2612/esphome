...
void TableObject::beforeTablesUnloadCallback(BeforeTablesUnloadCallback func) { _beforeTablesUnload = func; }

BeforeTablesUnloadCallback TableObject::beforeTablesUnloadCallback() { return _beforeTablesUnload; }
...
uint32_t TableObject::tableReference() { return (uint32_t) _memory.toRelative(_data); }
...
uint16_t TableObject::saveSize() { return 5 + InterfaceObject::saveSize() + sizeof(_size); }
