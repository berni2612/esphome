...
KNXValue::operator bool() const { return boolValue(); }

KNXValue::operator uint8_t() const { return ucharValue(); }

KNXValue::operator uint16_t() const { return ushortValue(); }

KNXValue::operator uint32_t() const { return uintValue(); }

KNXValue::operator uint64_t() const { return ulongValue(); }

KNXValue::operator int8_t() const { return charValue(); }

KNXValue::operator int16_t() const { return shortValue(); }

KNXValue::operator int32_t() const { return intValue(); }

KNXValue::operator int64_t() const { return longValue(); }

KNXValue::operator double() const { return doubleValue(); }

KNXValue::operator const char *() const { return stringValue(); }

KNXValue::operator struct tm() const { return timeValue(); }
...
bool KNXValue::boolValue() const {
  switch (_type) {
    ...
    case StringType:
      return strcmp(_value.stringValue, "true") == 0 || strcmp(_value.stringValue, "True") == 0 || longValue() != 0 ||
             doubleValue() != 0;
  }
  return 0;
}
...
KNXValue::operator float() const { return doubleValue(); }
