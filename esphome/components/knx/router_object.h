...
enum CouplerModel { Model_1x, Model_20 };
...
class RouterObject : public TableObject {
 public:
  ...
  void initialize(CouplerModel model, uint8_t objIndex, DptMedium mediumType, RouterObjectType rtType,
 ...
 private:
  // Function properties
  void functionRouteTableControl(bool isCommand, uint8_t *data, uint8_t length, uint8_t *resultData,
